...
# - Model Release
MODEL_RELEASE=https://github.com/desotaai/derunner/archive/refs/tags/v0.0.0.zip

# - Model Path
#   $PWD = \home\[username]\Desota\DeRunner\executables\Linux
MODEL_PATH=$USER_HOME/Desota/$MODEL_NAME
