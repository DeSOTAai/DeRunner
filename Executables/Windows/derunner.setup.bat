...
:: USER PATH
:: %~dp0 = C:\Users\[username]Desota\DeRunner\executables\windows
...
set model_path_basepath=Desota\%model_name%

:: - Model GIT
set model_release=https://github.com/desotaai/derunner/archive/refs/tags/v0.0.0.zip
...
set model_service_install_basepath=%model_service_basepath%\derunner.nssm.bat
set model_start_basepath=%model_service_basepath%\derunner.start.bat
...
:: IPUT ARGS
:: /manualstart :: Start Model Service Manually: %UserProfile%\Desota\DeRunner\executables\Windows\descraper.start.bat
